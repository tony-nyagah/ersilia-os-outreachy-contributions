...
def download_dataset(dataset_name, dataset_group):
    """
    ...
    is_classification = unique_values <= 10  # Assuming classification if 10 or fewer unique values
    ...
    if is_classification:
        ...
        if unique_values == 2:
            ...
            print(f"This is a multi-class classification dataset with {unique_values} classes ✓")
        # Check class distribution
        print("\nClass distribution:")
        for split_name, df in zip(['Train', 'Valid', 'Test'], [train_df, valid_df, test_df]):
